...
export class Blockfn extends React.Component<null, { editorState: Draft.EditorState; imgUrl: string }> {
  ...
  insertImage = () => {
    ...
    const contentStateWithEntity = contentState.createEntity("img", "IMMUTABLE", { src: this.state.imgUrl });
    const entityKey = contentStateWithEntity.getLastCreatedEntityKey();
    const newEditorState = Draft.EditorState.set(editorState, { currentContent: contentStateWithEntity });
