...
export class RegexDecorator extends React.Component<null, { editorState: Draft.EditorState; regex: string }> {
  state = {
    editorState: Draft.EditorState.createWithContent(
      Draft.ContentState.createFromText("The cat sat on the mat"),
      compositeDecorator
    ),
    regex: ""
  };
  ...
  regexChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    this.setState({
      ...
      editorState: Draft.EditorState.createWithContent(this.state.editorState.getCurrentContent(), compositeDecorator)
    });
  };
      ...
      <div>
        ...
        <div className="form-horizontal">
          <div className="form-group">
            <label htmlFor="regex" className="control-label col-sm-1">
              data
            </label>
